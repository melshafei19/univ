...
import com.edu.uni.model.Student;
...
public interface StudentRepository extends JpaRepository<Student, Integer> {
    ...
    @Query(" select new com.edu.uni.dto.StudentDetailsDTO(s.id, s.name, m.name, d1.name, c.name, c.creditHour, d2.name, p.name, s.dateOfBirth, s.email, s.phoneNumber, s.address, s.createdAt, s.updatedAt)" +
            " FROM Student s " +

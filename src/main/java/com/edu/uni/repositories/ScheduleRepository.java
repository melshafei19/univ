...
public interface ScheduleRepository extends JpaRepository<Schedule,Integer> {
    @Query(" select new com.edu.uni.dto.ScheduleDetailsDTO(s.id, c1.name, d.name, c2.buildingName, c2.roomNumber, m.name, s.dayOfWeek, s.startTime, s.endTime, s.createdAt, s.updatedAt)" +
            " FROM Schedule s " +
